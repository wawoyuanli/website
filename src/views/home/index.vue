<template>
	<div class="js home" id="page-top">
				...
				<div class="row" style="margin-top: 100px">
					...
					<div class="col-lg-6 right">
						<p>
							...
							they’re heading in the right direction; this information can save
							them a lot of time and money in the long run.
						</p>
						<div
							class="image"
							style="
						...
						>
							<img
								src="@/assets/images/camrecorder.png"
								alt=""
				...
				<div class="row">
					...
					<div class="col-lg-5">
						...
						<p style="padding-top: 2rem; font-size: 1rem">
							Redeem your points for gift cards to your favorite retailers like
							Amazon and Netflix or get cash back from PayPal.
						</p>
					</div>
				</div>
			</div>
		...
		<div class="swiper">
			...
			<div
				id="myCarousel"
				class="carousel slide slide-swiper"
				data-ride="carousel"
			>
...
.home {
	...
	.phone {
		background: linear-gradient(90deg, #4179c3, #84c7f1, #ddedfa)
			//linear-gradient(90deg, rgb(31, 117, 167) 0px, rgb(3, 190, 197));;
	}
	.middle-user-payout {
		background: #ffffff;
		.section-heading {
