<template>
	<div class="js home" id="page-top">
		...
		<div class="intro d-flex">
			<div class="container my-auto">
				<div class="row">
					...
					<img
						...
						alt=""
						style="margin-left: 37%; z-index: 10"
					/>
				</div>
			</div>
			<div
			...
			></div>
			<div
				class="skew skew-right"
				id="features"
				style="width: 100vw; height: auto; background: #fff"
			>
				<div class="container">
					<div class="row">
					...
					<div class="row">
						<div class="col-lg-4 col-md-6 text-center">
							<div class="status-box mx-auto mb-3 mb-lg-0">
								<i class="my-3"><img src="@/assets/images/earth.png" /></i>
								<h3>
				...
				<div
					...
					style="
						...
						z-index: 100;
						border-top: 100px solid transparent;
						border-right: 100vw solid rgba(3, 190, 197, 0.9);
					"
				></div>
				<div class="middle">
					<div class="container">
						<div class="row">
							<div class="col-lg-6 left">Easy ways to earn money</div>
							<div class="col-lg-6 right">
								<p>
									Companies often need feedback on their products to make sure
									they’re heading in the right direction; this information can
				...
				<div
					...
					style="
						...
						border-right: 100vw solid rgb(31, 117, 167);
					"
				></div>
        <div class="map-desc">
          <div class="container">
            <div class="row">
              ...
              <div class="col-lg-6">
                ...
                <p>Redeem your points for gift cards to your favorite retailers like Amazon and Netflix or get cash back from PayPal.</p>
              </div>
            </div>
          </div>
        </div>
        		<div
					...
					style="
						...
						z-index: 100;
						border-top: 100px solid transparent;
						border-left: 100vw solid rgb(31, 117, 167)	"
				></div>
