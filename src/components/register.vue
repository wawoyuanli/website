	...
	<div class="register-wrap">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-3"></div>
				<div class="col-md-3">
					<label for="email" class="col-md-12 mt-2"
						>Email
						<label style="color: red">*</label>
					</label>
					<input
				...
				<div class="col-md-3">
					<label for="sendCode" class="col-md-12 mt-2">
			...
			<div class="row">
				<div class="col-md-3"></div>
				<div class="col-md-3">
					<label for="firstName" class="col-md-12 mt-2"
						>FirstName
						<label style="color: red">*</label>
					</label>
					<input
				...
				<div class="col-md-3">
					<label for="lastName" class="col-md-12 mt-2"
						>LastName
						<label style="color: red">*</label>
					</label>
					<input
			...
			<div class="row">
				<div class="col-md-3"></div>
				<div class="col-md-6">
					<label for="sex" class="col-md-12 mt-2"
						>Sex
						<label style="color: red">*</label>
					</label>
			...
			<div class="row">
				<div class="col-md-3"></div>
				<div class="col-md-2">
					<label for="sex" class="col-md-12 mt-2 mb-2"
						>Birthday year
						<label style="color: red">*</label>
					</label>
					<date-picker
				...
				<div class="col-md-2">
					<label for="birthdaymonth" class="col-md-12 mt-2 mb-2"
						>Birthday month
						<label style="color: red">*</label>
					</label>
					<date-picker
			...
			<div class="row">
				<div class="col-md-3"></div>
				<div class="col-md-6">
					<label for="address" class="col-md-12 mt-2"
			...
			<div class="row">
				<div class="col-md-3"></div>
				<div class="col-md-6 mt-4">Detected country:</div>
			</div>
			<div class="row">
				<div class="col-md-3"></div>
				<div class="col-md-6">
