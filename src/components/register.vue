	...
	<div class="register-wrap">
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-3"></div>
				<div class="col-lg-2">
					<label for="sex" class="control-label mt-2 mb-2"
						>Birthday year
						<label style="color: red">*</label>
					</label>
          <date-picker v-model="time1" type="year" value-type="format" format="YYYY" ></date-picker>
				</div>
				<div class="col-lg-2">
					<label for="birthdaymonth" class="control-label mt-2 mb-2"
						>Birthday month
						<label style="color: red">*</label>
					</label>
				 <date-picker v-model="time2" type="month"  value-type="format" format="M"></date-picker>
				</div>
				<div class="col-lg-2">
					<label for="sex" class="control-label mt-2 mb-2"
						>Birthday day
			 ...
			 <date-picker v-model="time3" type="day" format="D" value-type="format" ></date-picker>
				</div>
			</div>
			<!--address-->
			<div class="row">
