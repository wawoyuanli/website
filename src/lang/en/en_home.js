export default {
  ...
  /**第三部分 */
  our: "Our Achievement",
  second_title:"Based on your demographics, OYA Survey will provide you with paid research and market research opportunities and will provide you with remuneration.",
  ...
  fiveText1: `We need you. Your opinion matters.
    `,
    fiveText2:`OYA Survey is looking for people to participate in Paid Online Surveys.`,
  /**第六部分 左标题*/
  company: 'Company',
  home: 'Home',
  about: 'About Us',
  ...
  bottom: '© 2021 Kroses Trading Inc. All Rights Seserved.',

  /**为什么要注册云顶咨询？ */
  why: 'Why sign up to OYA Survey?',
  reasons: 'Why OYA Survey is unique and reasons behindit.',
